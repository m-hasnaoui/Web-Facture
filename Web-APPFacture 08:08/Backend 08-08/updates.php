...
if ($_POST['METHOD'] == 'PUT') {
    ...
    $query = "UPDATE users SET user_upd=:user_upd, password = :password, first_login = :first_login WHERE idUser = :idUser";
    $params = array(':idUser' => $idUser, ':user_upd' => $user_upd, ':password' => $password,':first_login' => $first_login);
